...
const Header: React.FC<IHeaderProps> = ({ Hello, services, work }) => {
  ...
  return (
    <header className='flex items-center justify-around  mt-8 relative z-40'>
      <section className='flex items-center justify-around max-iphone:gap-16 text-white flex-wrap-reverse absolute z-40 w-screen'>
        ...
        <button
          type='button'
          className='bg-[#21D19F] p-2 px-8  max-iphone:px-5 max-iphone:p-1 rounded-sm sm:text-black lg:hover:p-3 lg:hover:px-9 duration-300 delay-150 ease-out'
