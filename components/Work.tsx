...
const Work = () => {
  ...
  return (
    <div className='text-white w-full justify-around flex items-center h-full max-ipad:h-full max-tablet:flex-col max-tablet:row'>
      <div className='max-ipad:hidden'>
        <p className='text-[25rem] text-[#3a3a3a79] font-thin'>&#123;</p>
      </div>
      <h1 className='text-3xl my-3 max-ipad:my-1 max-ipad:text-xl tablet:hidden'>
      ...
      <motion.div
        ...
        initial='hidden'
        animate='visible'
        className='flex flex-col h-full text-center gap-2 w-full ml-4 max-ipad:ml-0 max-ipad:max-h-full max-tablet:flex-row '
      >
        <h1 className='text-3xl my-3 max-ipad:my-1 max-ipad:text-xl max-tablet:hidden'>
          Projects<span className='text-[#21d19f] text-2xl'>.</span>
        </h1>
        {work.map((item) => (
          <motion.div
            ...
            className=' flex w-full flex-row-reverse py-2  bg-[#080808] rounded-md text-start  max-ipad:h-5/6 max-tablet:flex-col max-tablet:w-1/3 max-tablet:h-full max-tablet:gap-4'
          >
            <motion.section
              variants={itemVariants}
              initial='hidden'
              animate='visible'
              className='flex-auto flex justify-center mr-4 max-ipad:mr-2 max-tablet:mx-1'
            >
              <Image
                src={`/${item.name}`}
                alt={item.name}
            ...
            <motion.section
              ...
              initial='hidden'
              animate='visible'
              className='flex flex-col rounded-md flex-auto gap-4 max-ipad:gap-3 pl-4 max-ipad:pl-2  w-3/5 h-2/3 max-ipad:w-full max-ipad:h-full max-tablet:pl-1'
            >
              ...
              <article className='gap-5 flex max-tablet:gap-2'>
                <Link
                  href={item.linkGit}
                  target='_blank'
                ...
                >
                  <p className='max-tablet:text-xs'>
                    <SiCodereview />
                  </p>
                  <p className='max-tablet:text-xs  max-tablet:text-center'>{item.github}</p>
                ...
                >
                  ...
                  <p className='max-tablet:text-xs max-tablet:text-center'>{item.deploy}</p>
                </Link>
              </article>
